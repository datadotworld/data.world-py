...
class DatasetsApi(object):
	...
	def get_dataset(self, owner_id, project_id):
		'''Retrieve a dataset. The definition of the dataset will be returned, not the associated data.
	...
	def create_dataset(self, owner_id, **kwargs):
        ...
        '''
		try:
			url = '{}/datasets/{}'.format(self.api_client._api_url, owner_id)
