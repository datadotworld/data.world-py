...
class Range(object):
    ...
    def end_date(self):
        ...
        Inclusive. Format is YYYY-MM-DD in UTC. If inputted by itself (without startDate), it will match all dates before this date and this date.  # noqa: E501
    ...
    def start_date(self):
        ...
        Inclusive. Format is YYYY-MM-DD in UTC. If inputted by itself (without endDate),it will match all dates after this date and this date.  # noqa: E501
