...
class ServiceAccountUpdateDto(object):
    """
    ...
    def __init__(self, active=False):
        """
        ServiceAccountUpdateDto - a model defined in Swagger
        """
    ...
    def active(self):
        """
        Gets the active of this ServiceAccountUpdateDto.

        :return: The active of this ServiceAccountUpdateDto.
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """
        Sets the active of this ServiceAccountUpdateDto.

        :param active: The active of this ServiceAccountUpdateDto.
        :type: bool
        """
        if active is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ServiceAccountUpdateDto):
            return False
