...
class DatasetPatchRequest(object):
    ...
    def __init__(self, description=None, files=None, license=None, summary=None, tags=None, title=None, visibility=None):
        """
    ...
    def files(self):
        """
        Gets the files of this DatasetPatchRequest.
        Updated set of files. At dataset update time, file uploads are not supported. However, this property can be used to add files via URL or update metadata related to existing files.

        :return: The files of this DatasetPatchRequest.
    ...
    def files(self, files):
        ...
        :param files: The files of this DatasetPatchRequest.
