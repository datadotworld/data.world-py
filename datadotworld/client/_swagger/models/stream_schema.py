...
class StreamSchema(object):
    ...
    def __init__(self, primary_key_fields=None, sequence_field=None):
        """
        StreamSchema - a model defined in Swagger
        """
    ...
    def primary_key_fields(self):
        """
        Gets the primary_key_fields of this StreamSchema.
        One or more fields that make up the primary key of a record

        :return: The primary_key_fields of this StreamSchema.
        :rtype: list[str]
        """
    ...
    def primary_key_fields(self, primary_key_fields):
        ...
        :param primary_key_fields: The primary_key_fields of this StreamSchema.
        :type: list[str]
        """
    ...
    def sequence_field(self):
        """
        Gets the sequence_field of this StreamSchema.
        A numeric or datetime field by which to sort records for the purpose of deduplication 

        :return: The sequence_field of this StreamSchema.
        :rtype: str
        """
    ...
    def sequence_field(self, sequence_field):
        ...
        :param sequence_field: The sequence_field of this StreamSchema.
        :type: str
        """
