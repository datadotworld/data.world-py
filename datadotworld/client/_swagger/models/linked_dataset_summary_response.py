...
class LinkedDatasetSummaryResponse(object):
    ...
    def __init__(self, owner=None, id=None, title=None, description=None, summary=None, version=None, tags=None, license=None, visibility=None, created=None, updated=None, access_level=None):
        """
