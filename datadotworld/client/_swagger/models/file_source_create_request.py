...
class FileSourceCreateRequest(object):
    ...
    def database_source(self):
        """
        Gets the database_source of this FileSourceCreateRequest.

        :return: The database_source of this FileSourceCreateRequest.
    ...
    def database_source(self, database_source):
        """
        Sets the database_source of this FileSourceCreateRequest.

        :param database_source: The database_source of this FileSourceCreateRequest.
    ...
    def dwcc_spec(self):
        """
        Gets the dwcc_spec of this FileSourceCreateRequest.

        :return: The dwcc_spec of this FileSourceCreateRequest.
        :rtype: DwccSpecDto
        """
    ...
    def dwcc_spec(self, dwcc_spec):
        """
        Sets the dwcc_spec of this FileSourceCreateRequest.

        :param dwcc_spec: The dwcc_spec of this FileSourceCreateRequest.
        :type: DwccSpecDto
        """
    ...
    def view_request(self):
        """
        Gets the view_request of this FileSourceCreateRequest.

        :return: The view_request of this FileSourceCreateRequest.
    ...
    def view_request(self, view_request):
        """
        Sets the view_request of this FileSourceCreateRequest.

        :param view_request: The view_request of this FileSourceCreateRequest.
        :type: ViewRequestDto
        """
    ...
    def database_metadata_spec(self):
        """
        Gets the database_metadata_spec of this FileSourceCreateRequest.

        :return: The database_metadata_spec of this FileSourceCreateRequest.
    ...
    def database_metadata_spec(self, database_metadata_spec):
        """
        Sets the database_metadata_spec of this FileSourceCreateRequest.

        :param database_metadata_spec: The database_metadata_spec of this FileSourceCreateRequest.
    ...
    def data_tables(self):
        """
        Gets the data_tables of this FileSourceCreateRequest.

        :return: The data_tables of this FileSourceCreateRequest.
    ...
    def data_tables(self, data_tables):
        """
        Sets the data_tables of this FileSourceCreateRequest.

        :param data_tables: The data_tables of this FileSourceCreateRequest.
    ...
    def table_spec(self):
        """
        Gets the table_spec of this FileSourceCreateRequest.

        :return: The table_spec of this FileSourceCreateRequest.
    ...
    def table_spec(self, table_spec):
        """
        Sets the table_spec of this FileSourceCreateRequest.

        :param table_spec: The table_spec of this FileSourceCreateRequest.
