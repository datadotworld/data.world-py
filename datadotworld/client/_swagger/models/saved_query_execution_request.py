...
class SavedQueryExecutionRequest(object):
    ...
    def __init__(self, parameters=None, include_table_schema=False):
        """
    ...
    def parameters(self):
        ...
        Specifies values for named query parameters. parameters must be map-like object (key-value pairs), where keys are the names of the parameters and values what those parameters should be set to when the query is executed.
