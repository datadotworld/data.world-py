...
class MetadataRequest(object):
    ...
    def collections(self):
        """
        Gets the collections of this MetadataRequest.
        ...
        :return: The collections of this MetadataRequest.
        :rtype: list[str]
        """
    ...
    def collections(self, collections):
        """
        Sets the collections of this MetadataRequest.
        Catalog Collection to which this metadata resource is added. Required for POST and PUT.Available catalog collection can be discovered via appropriate discovery endpoints.

        :param collections: The collections of this MetadataRequest.
        :type: list[str]
        """
    ...
    def title(self):
        """
        Gets the title of this MetadataRequest.
        Title of the metadata resource. Required for POST and PUT.

        :return: The title of this MetadataRequest.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """
        Sets the title of this MetadataRequest.
        Title of the metadata resource. Required for POST and PUT.

        :param title: The title of this MetadataRequest.
        :type: str
        """
    ...
    def type_label(self):
        """
        Gets the type_label of this MetadataRequest.
        ...
        :return: The type_label of this MetadataRequest.
        :rtype: str
        """
    ...
    def type_label(self, type_label):
        """
        Sets the type_label of this MetadataRequest.
        Indicates the type of metadata resource. Some examples of valid values are Report, Tableau dashboard, Glossary, Table, Database view etc. Default values will be assumed if not provided. Defaults to Report for analysis resources, Glossary for Glossary resources, Table for Table resources and Column for Column resources. Once specified during creation, this cannot be changed via PATCH. Only a PUT can change the type 

        :param type_label: The type_label of this MetadataRequest.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this MetadataRequest.
        A short, but descriptive statement about the metadata resource.

        :return: The description of this MetadataRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this MetadataRequest.
        A short, but descriptive statement about the metadata resource.

        :param description: The description of this MetadataRequest.
        :type: str
        """
    ...
    def tags(self, tags):
        """
        Sets the tags of this MetadataRequest.
        A collection of tags to identify the relevance of metadata resource. Tags with no spaces is defacto standard

        :param tags: The tags of this MetadataRequest.
        :type: list[str]
        """
    ...
    def properties(self):
        """
        Gets the properties of this MetadataRequest.
        ...
        :return: The properties of this MetadataRequest.
    ...
    def properties(self, properties):
        """
        Sets the properties of this MetadataRequest.
        Custom properties for the metadata resource mapped to API BindingsCan be simple name-value string pairs or nested values for a string name. See examples for details.

        :param properties: The properties of this MetadataRequest.
