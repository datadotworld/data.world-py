...
class MetadataSuggestRequest(object):
    """
    ...
    def __init__(self, collections_to_add=None, collections_to_remove=None, title=None, type_label=None, description=None, tags_to_add=None, tags_to_remove=None, message=None, properties=None):
        """
        MetadataSuggestRequest - a model defined in Swagger
        """
    ...
    def collections_to_add(self):
        """
        Gets the collections_to_add of this MetadataSuggestRequest.
        ...
        :return: The collections_to_add of this MetadataSuggestRequest.
        :rtype: list[str]
        """
    ...
    def collections_to_add(self, collections_to_add):
        """
        Sets the collections_to_add of this MetadataSuggestRequest.
        Catalog Collection to which this metadata resource is added. Required for POST and PUT.Available catalog collection can be discovered via appropriate discovery endpoints.

        :param collections_to_add: The collections_to_add of this MetadataSuggestRequest.
        :type: list[str]
        """
    ...
    def collections_to_remove(self):
        """
        Gets the collections_to_remove of this MetadataSuggestRequest.
        Catalog Collection to which this metadata resource is added. Required for POST and PUT.Available catalog collection can be discovered via appropriate discovery endpoints.

        :return: The collections_to_remove of this MetadataSuggestRequest.
        :rtype: list[str]
        """
    ...
    def collections_to_remove(self, collections_to_remove):
        """
        Sets the collections_to_remove of this MetadataSuggestRequest.
        Catalog Collection to which this metadata resource is added. Required for POST and PUT.Available catalog collection can be discovered via appropriate discovery endpoints.

        :param collections_to_remove: The collections_to_remove of this MetadataSuggestRequest.
        :type: list[str]
        """
    ...
    def title(self):
        """
        Gets the title of this MetadataSuggestRequest.
        Title of the metadata resource. Required for POST and PUT.

        :return: The title of this MetadataSuggestRequest.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """
        Sets the title of this MetadataSuggestRequest.
        Title of the metadata resource. Required for POST and PUT.

        :param title: The title of this MetadataSuggestRequest.
        :type: str
        """
    ...
    def type_label(self):
        """
        Gets the type_label of this MetadataSuggestRequest.
        ...
        :return: The type_label of this MetadataSuggestRequest.
        :rtype: str
        """
    ...
    def type_label(self, type_label):
        """
        Sets the type_label of this MetadataSuggestRequest.
        Indicates the type of metadata resource. Some examples of valid values are Report, Tableau dashboard, Glossary, Table, Database view etc. Default values will be assumed if not provided. Defaults to Report for analysis resources, Glossary for Glossary resources, Table for Table resources and Column for Column resources. Once specified during creation, this cannot be changed via PATCH. Only a PUT can change the type 

        :param type_label: The type_label of this MetadataSuggestRequest.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this MetadataSuggestRequest.
        A short, but descriptive statement about the metadata resource.

        :return: The description of this MetadataSuggestRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this MetadataSuggestRequest.
        A short, but descriptive statement about the metadata resource.

        :param description: The description of this MetadataSuggestRequest.
        :type: str
        """
    ...
    def tags_to_add(self, tags_to_add):
        """
        Sets the tags_to_add of this MetadataSuggestRequest.
        A collection of tags to identify the relevance of metadata resource. Tags with no spaces is defacto standard

        :param tags_to_add: The tags_to_add of this MetadataSuggestRequest.
        :type: list[str]
        """
    ...
    def tags_to_remove(self):
        """
        Gets the tags_to_remove of this MetadataSuggestRequest.
        A collection of tags to identify the relevance of metadata resource. Tags with no spaces is defacto standard

        :return: The tags_to_remove of this MetadataSuggestRequest.
        :rtype: list[str]
        """
    ...
    def tags_to_remove(self, tags_to_remove):
        """
        Sets the tags_to_remove of this MetadataSuggestRequest.
        A collection of tags to identify the relevance of metadata resource. Tags with no spaces is defacto standard

        :param tags_to_remove: The tags_to_remove of this MetadataSuggestRequest.
        :type: list[str]
        """
    ...
    def message(self):
        """
        Gets the message of this MetadataSuggestRequest.
        Message for the suggestion

        :return: The message of this MetadataSuggestRequest.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this MetadataSuggestRequest.
        Message for the suggestion

        :param message: The message of this MetadataSuggestRequest.
        :type: str
        """
    ...
    def properties(self):
        """
        Gets the properties of this MetadataSuggestRequest.
        ...
        :return: The properties of this MetadataSuggestRequest.
    ...
    def properties(self, properties):
        """
        Sets the properties of this MetadataSuggestRequest.
        Custom properties for the metadata resource mapped to API BindingsCan be simple name-value string pairs or nested values for a string name. See examples for details.

        :param properties: The properties of this MetadataSuggestRequest.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, MetadataSuggestRequest):
            return False
