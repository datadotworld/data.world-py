...
class DescribeApi(object):
    ...
    def query_via_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.query_via_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.query_via_get_with_http_info(**kwargs)
        else:
            (data) = self.query_via_get_with_http_info(**kwargs)
            return data

    def query_via_get_with_http_info(self, **kwargs):
        """
        SPARQL DESCRIBE query
        This endpoint executes a SPARQL DESCRIBE query, given an IRI. .
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.query_via_get_with_http_info(callback=callback_function)
        ...
        all_params = ['iri', 'queryruntoken', 'namespace']
        ...
        return self.api_client.call_api('/describe', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
