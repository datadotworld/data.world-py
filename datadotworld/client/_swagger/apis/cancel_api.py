...
class CancelApi(object):
    ...
    def cancel(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.cancel(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str queryruntoken:
        :return: None
        ...
        if kwargs.get('callback'):
            return self.cancel_with_http_info(**kwargs)
        else:
            (data) = self.cancel_with_http_info(**kwargs)
            return data

    def cancel_with_http_info(self, **kwargs):
        """
        Cancel a query
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.cancel_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/cancel', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
