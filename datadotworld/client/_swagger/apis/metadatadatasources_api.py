...
class MetadatadatasourcesApi(object):
    """
    ...
    def get_databases(self, owner, **kwargs):
        ...
        :param str _from:
        :param str sort:
        :return: PaginatedDatabaseResults
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_databases_with_http_info(self, owner, **kwargs):
        ...
        return self.api_client.call_api('/metadata/data/sources/{owner}', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PaginatedDatabaseResults',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def suggest_catalog_table(self, owner, sourceid, tableid, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.suggest_catalog_table(owner, sourceid, tableid, body, callback=callback_function)
        ...
        :param str sourceid: database source id (required)
        :param str tableid: (required)
        :param CatalogTableSuggestRequest body: (required)
        :return: SuccessMessage
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.suggest_catalog_table_with_http_info(owner, sourceid, tableid, body, **kwargs)
        else:
            (data) = self.suggest_catalog_table_with_http_info(owner, sourceid, tableid, body, **kwargs)
            return data

    def suggest_catalog_table_with_http_info(self, owner, sourceid, tableid, body, **kwargs):
        """
        suggest for an existing table.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.suggest_catalog_table_with_http_info(owner, sourceid, tableid, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method suggest_catalog_table" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if ('owner' not in params) or (params['owner'] is None):
            raise ValueError("Missing the required parameter `owner` when calling `suggest_catalog_table`")
        # verify the required parameter 'sourceid' is set
        if ('sourceid' not in params) or (params['sourceid'] is None):
            raise ValueError("Missing the required parameter `sourceid` when calling `suggest_catalog_table`")
        # verify the required parameter 'tableid' is set
        if ('tableid' not in params) or (params['tableid'] is None):
            raise ValueError("Missing the required parameter `tableid` when calling `suggest_catalog_table`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `suggest_catalog_table`")
        ...
        return self.api_client.call_api('/metadata/data/sources/suggest/{owner}/{sourceid}/tables/{tableid}', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
