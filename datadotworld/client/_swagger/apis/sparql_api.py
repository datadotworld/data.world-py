...
class SparqlApi(object):
    ...
    def sparql_get(self, owner, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.sparql_get(owner, id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.sparql_get_with_http_info(owner, id, **kwargs)
        else:
            (data) = self.sparql_get_with_http_info(owner, id, **kwargs)
            return data

    def sparql_get_with_http_info(self, owner, id, **kwargs):
        """
        SPARQL query (via GET)
        This endpoint executes SPARQL queries against a dataset. New to SPARQL? Check out data.world's [SPARQL tutorial](https://docs.data.world/tutorials/sparql/) .
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.sparql_get_with_http_info(owner, id, callback=callback_function)
        ...
        resource_path = '/sparql/{owner}/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'owner' in params:
    ...
    def sparql_post(self, owner, id, **kwargs):
        """
        SPARQL query
        This endpoint executes SPARQL queries against a dataset. New to SPARQL? Check out data.world's [SPARQL tutorial](https://docs.data.world/tutorials/sparql/) .
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.sparql_post(owner, id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.sparql_post_with_http_info(owner, id, **kwargs)
        else:
            (data) = self.sparql_post_with_http_info(owner, id, **kwargs)
            return data

    def sparql_post_with_http_info(self, owner, id, **kwargs):
        """
        SPARQL query
        This endpoint executes SPARQL queries against a dataset. New to SPARQL? Check out data.world's [SPARQL tutorial](https://docs.data.world/tutorials/sparql/) .
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.sparql_post_with_http_info(owner, id, callback=callback_function)
