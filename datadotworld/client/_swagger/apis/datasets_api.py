...
class DatasetsApi(object):
    ...
    def add_files_by_source(self, owner, id, body, **kwargs):
        """
        Add files
        This method allows files published on the web to be added to a data.world dataset via their URL. The source URL will be stored so you can easily update your file anytime it changes via the *fetch latest* link on the [data.world](https://data.world/) dataset page or by triggering the GET:/sync endpoint.
    ...
    def add_files_by_source_with_http_info(self, owner, id, body, **kwargs):
        ...
        resource_path = '/datasets/{owner}/{id}/files'.replace('{format}', 'json')
        path_params = {}
        if 'owner' in params:
    ...
    def create_dataset_with_http_info(self, owner, body, **kwargs):
        ...
        resource_path = '/datasets/{owner}'.replace('{format}', 'json')
        path_params = {}
        if 'owner' in params:
            path_params['owner'] = params['owner']
    ...
    def delete_file_and_sync_source_with_http_info(self, owner, id, name, **kwargs):
        ...
        resource_path = '/datasets/{owner}/{id}/files/{name}'.replace('{format}', 'json')
        path_params = {}
        if 'owner' in params:
            path_params['owner'] = params['owner']
        if 'id' in params:
    ...
    def delete_files_and_sync_sources(self, owner, id, name, **kwargs):
        """
        Delete files
        Delete one or more files from a dataset by their name, including files added via URL.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
    ...
    def get_dataset_with_http_info(self, owner, id, **kwargs):
        ...
        resource_path = '/datasets/{owner}/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'owner' in params:
            path_params['owner'] = params['owner']
        if 'id' in params:
    ...
    def sync(self, owner, id, **kwargs):
        """
        Sync files
        Update all files within a dataset that have originally been added via URL (e.g. via /datasets endpoints or on data.world).
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
    ...
    def sync_with_http_info(self, owner, id, **kwargs):
        ...
        resource_path = '/datasets/{owner}/{id}/sync'.replace('{format}', 'json')
        path_params = {}
        if 'owner' in params:
            path_params['owner'] = params['owner']
        if 'id' in params:
