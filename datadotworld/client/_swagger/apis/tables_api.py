...
class TablesApi(object):
    ...
    def create_new_tables(self, owner, id, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_new_tables(owner, id, body, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_new_tables_with_http_info(owner, id, body, **kwargs)
        else:
            (data) = self.create_new_tables_with_http_info(owner, id, body, **kwargs)
            return data
    ...
    def create_new_tables_with_http_info(self, owner, id, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_new_tables_with_http_info(owner, id, body, callback=callback_function)
        ...
        if ('owner' not in params) or (params['owner'] is None):
            raise ValueError("Missing the required parameter `owner` when calling `create_new_tables`")
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `create_new_tables`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_new_tables`")
