...
class UserApi(object):
    ...
    def fetch_contributing_datasets(self, **kwargs):
        ...
        :param str sort: Property name to sort by. Prefix with `+` for ascending order or with `-` for descending order. For example, `-created` will return items sorted by the `created` property in descending order.
    ...
    def fetch_contributing_datasets_with_http_info(self, **kwargs):
        ...
        resource_path = '/user/datasets/contributing'.replace('{format}', 'json')
        path_params = {}
    ...
    def fetch_datasets_with_http_info(self, **kwargs):
        ...
        resource_path = '/user/datasets/own'.replace('{format}', 'json')
        path_params = {}
    ...
    def fetch_liked_datasets_with_http_info(self, **kwargs):
        ...
        resource_path = '/user/datasets/liked'.replace('{format}', 'json')
        path_params = {}
